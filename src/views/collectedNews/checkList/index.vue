<template>
  <div class="app-container">
    ...
    <el-form :model="form" ref="form" :rules="headRules" label-width="190px" size="mini">
      <el-row>
        <el-col :span="12">
          <el-form-item label="申报地海关" prop="borderTransportMeans.borderTransportMeansId">
            <el-input
              v-model="form.borderTransportMeans.borderTransportMeansId"
              placeholder="请输入运输申报地海关"
              clearable
              size="mini"               
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="单据状态" prop="borderTransportMeans.borderTransportMeansId">
            <el-input
              v-model="form.borderTransportMeans.borderTransportMeansId"
              placeholder="请输入单据状态"
              clearable
        ...
        <el-row>
        <el-col :span="12">
          <el-form-item label="中心统一编号" prop="borderTransportMeans.name">
            <el-input
         ...
         <el-col :span="12">
          <el-form-item label="海关编号" prop="borderTransportMeans.name">
            <el-input
              v-model="form.borderTransportMeans.name"
              placeholder="请输入海关编号"
              clearable
