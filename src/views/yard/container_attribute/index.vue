  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="押金价格(￥)" prop="pledgePrice">
        <el-input
          v-model="queryParams.pledgePrice"
          placeholder="请输入押金价格(￥)"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="container_attributeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="尺寸(长宽高)" align="center" prop="boxSize" />
    ...
    <el-dialog :title="title" :visible.sync="open"  append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="尺寸(长宽高)" prop="boxSize">
          <el-input v-model="form.boxSize" placeholder="请输入尺寸(长宽高)" />
        </el-form-item>
      </el-form>
		...
		data() {
			return {
				...
				rules: {
					...
					boxSize: [
						{ required: true, message: "尺寸(长宽高)不能为空", trigger: "blur" }
					],
				}
			};
		},
