  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="堆场" prop="yardId">
        <el-select v-model="queryParams.yardId" placeholder="请选择堆场" @change="getYardZoneList">
          <el-option
            v-for="dept in depts"
            :key="dept.deptId"
            :label="dept.deptName"
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="原货位号" prop="zoneCode">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="新货位号" prop="zoneCode">
              <el-select v-model="form.containerNewStoreCode" placeholder="请输入货位">
                <el-option
