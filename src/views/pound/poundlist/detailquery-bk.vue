      ...
      <el-form ref="formModify" :model="poundModify" :rules="rulesModify" label-width="120px">
        ...
        <div v-show="selectPound.viaType === '01'">
          <el-row :gutter="10">
            <el-col :span="11">
              <el-form-item label="合同号" prop="contactNo">
                <el-input v-model="poundModify.contactNo" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2" class="modifyTo">修改为</el-col>
            <el-col :span="11">
              <!-- <el-input v-model="poundModify.modifyCoalBillNo" disabled></el-input>-->
              <el-form-item label="合同" prop="modifyContactNo">
                <el-select v-model="poundModify.modifyContactNo" filterable placeholder="请选择合同号"
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="11">
              <!-- <el-input v-model="poundModify.modifyCoalBillNo" disabled></el-input>-->
              <el-form-item label="库位号" prop="modifyStoreStoreCode">
...
export default {
  ...
  methods: {
    ...
    handleApply(row) {
      ...
      this.poundModify.vehicleNo = row.plateNum
      this.poundModify.modifyVehicleNo = row.plateNum
      this.poundModify.contractNo = row.remark
      this.poundModify.storeCode = row.locationNumber //库位号
