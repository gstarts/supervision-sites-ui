          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-form-item label="唛头" prop="shippingMarks">
                <el-input v-model="ioSub.shippingMarks" placeholder="请输入唛头"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="srnNo" prop="srnNo">
                <el-input v-model="ioSub.srnNo" placeholder="请输入srnNo"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-form-item label="品质" prop="quality">
                <el-input v-model="ioSub.quality" placeholder="请输入品质"/>
              </el-form-item>
            </el-col>
          </el-row>
        </el-row>
...
<script>
	import {getIo, addIo} from "@/api/place/io";
