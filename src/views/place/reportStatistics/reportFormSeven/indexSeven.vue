...
<!--      </div>-->
    ...
    <el-table v-loading="loading" :data="reportList" id="analyouttable" show-summary
      ...
      <af-table-column label="已完成车辆" align="center" prop="column7"/>
      <af-table-column label="已提离重量" align="center" prop="column8"/>
      <af-table-column label="剩余重量" align="center" prop="column9"/>
