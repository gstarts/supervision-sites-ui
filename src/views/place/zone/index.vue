    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="10">
          ...
          <el-col :span="8">
            <el-form-item label="区域类型" prop="zoneType">
              <el-select v-model="form.zoneType" placeholder="请选择区域类型" @change="changeZoneType">
                <el-option
                  v-for="dict in zoneTypeOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="8">
            <el-form-item label="区域别名" prop="zoneAlias">
              <el-input v-model="form.zoneAlias" placeholder="请输入区域别名"/>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="8">
            <el-form-item label="存放行数" prop="storageRows">
              <el-input v-model.number="form.storageRows" placeholder="请输入存放行数"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="存放列数" prop="storageColumns">
              <el-input v-model.number="form.storageColumns" placeholder="请输入存放列数" :disabled="selBulk"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="货位层数" prop="storeLevel">
              <el-input v-model.number="form.storeLevel" placeholder="请输入货位层数" :disabled="selBulk"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10">
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        id: undefined,
        placeId: this.queryParams.placeId, //等于页面中显示的场所
        zoneType: undefined,
        zoneName: undefined,
        zoneCode: undefined,
    ...
    changeZoneType(event) {
      console.log(event)
      if (event === '2') { //散杂货
        this.rules = this.rulesBulk
        this.form.storageColumns = 1
