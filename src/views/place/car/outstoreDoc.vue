<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="作废人" prop="voidUser">
        <el-input
          v-model="queryParams.voidUser"
          placeholder="请输入作废人"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-dialog :title="title" :visible.sync="open"  append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="作废人" prop="voidUser">
          <el-input v-model="form.voidUser" placeholder="请输入作废人" />
        </el-form-item>
      </el-form>
...
<script>
import { listDoc, getDoc, delDoc, addDoc, updateDoc } from "@/api/place/outstoreDoc";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('place/doc/export', {
        ...this.queryParams
      }, `place_doc.xlsx`)
    }
  }
