<<<<<<< HEAD:src/views/manifest/rmft4404/add4404/addcar.vue
<template>
  ...
  <div class="app-container">
    ...
    <el-form :model="form" ref="form" label-width="190px" size="mini" >
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="企业代码" prop="contractorcodescc">
            <el-select v-model="form.contractorcodescc" placeholder="请选择"  @change="change">
            <el-option
...
>>>>>>> 56cd18f4605da2c3602d9868db08979e394997b5:src/views/manifest/rmft4404/add4404.vue
