<<<<<<< HEAD:src/views/manifest/rmft4404/head4404/details.vue
<template>
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="货物运输批次号" prop="id">
            <el-input v-model="form.id" :disabled="true" placeholder="请输入货物运输批次号" />
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="传输企业备案关区" prop="feedbackMsg">
            <el-input
              v-model="queryParams.feedbackMsg"
              :disabled="true"
      ...
      <el-row>
        ...
        <el-col :span="18">
          <el-form-item label="确报传输人名称" prop="representativeperson">
            <el-input
              v-model="form.representativeperson"
              :disabled="true"
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="托架/拖挂车编号" prop="id">
            <el-input v-model="Tform.transportId" :disabled="true" placeholder="请输入托架/拖挂车编号" size="mini" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="托架/拖挂车类型" prop="typecode">
            <el-input
              v-model="Tform.typecode"
              :disabled="true"
              placeholder="请输入托架/拖挂车类型"
              size="mini"
            />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="托架/拖挂车自重(kg)" prop="tareweight">
            <el-input
              v-model="Tform.tareweight"
              :disabled="true"
              placeholder="请输入托架/拖挂车自重"
              size="mini"
            />
          </el-form-item>
        </el-col>
...
>>>>>>> 56cd18f4605da2c3602d9868db08979e394997b5:src/views/manifest/rmft4404/details4404.vue
