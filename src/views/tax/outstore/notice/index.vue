  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="outstore_noticeList">
     <!-- <af-table-column type="selection" width="55" align="center" />-->
      ...
      <af-table-column label="客户" align="center" prop="receiveName" />
    ...
    <el-dialog :title="title" :visible.sync="open"  append-to-body>
       ...
       <el-form-item label="批次号" prop="batchNo">
        ...
        <el-col :span="12">
         <el-form-item label="寄舱客户" prop="checkConsumer">
          ...
          <el-input v-model="form.driverIdCard" placeholder="请输入司机司机身份证号" />
        </el-form-item>
         </el-col>
        <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item label="客户" prop="receiveName">
