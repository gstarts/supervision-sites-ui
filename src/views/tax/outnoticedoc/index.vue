        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="预计出仓日期" prop="estimateOutDate">
              <el-input v-model="info.estimateOutDate" readonly/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="装货时间" prop="loadingDate">
              <el-input v-model="info.loadingDate" readonly/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="出货时间" prop="shipmentDate">
              <el-input v-model="info.shipmentDate" readonly/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="扩大共享级别" prop="expandSharingLevels">
              <el-input v-model="info.expandSharingLevels" readonly/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="录入人">
              <el-input v-model="info.inputUserName" placeholder/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
import {getInNoticeList} from "@/api/tax/indoc";
  ...
  methods: {
    ...
    handleStatusChangeShtg(row) {
      this.$confirm("确认要审核通过出库通知单吗?", "警告", {
        ...
        .then(function () {
          return changeDocStatus(row.outNoticeDocId, 2);
        })
        .then(() => {
    ...
    handleStatusChangeShbtg(row) {
      this.$confirm("确认要审核不通过出库通知单吗?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
        .then(function () {
          return changeDocStatus(row.outNoticeDocId, 0);
        })
        .then(() => {
