<template>
  <div class="app-container">
    ...
    >
      ...
      <af-table-column label="库位" align="center" prop="bookStoreCode" />
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            @click="handleLocationUpdate(scope.row)"
            v-hasPermi="['tax:instore_doc_detail:list']"
            >修改库位
          </el-button>
          <el-button
            size="mini"
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="报关单号" prop="customsDeclarationNo">
          <el-input
            v-model="form.customsDeclarationNo"
            placeholder="请输入报关单号"
          />
        </el-form-item>
        <el-form-item label="提运单号" prop="deliveryNo">
    ...
    <!-- 修改库位对话框 -->
    <el-dialog :title="title" :visible.sync="openStore" append-to-body>
      <el-form
        ref="storeForm"
        :model="storeForm"
        :rules="rules"
      ...
      >
        <!-- <el-form-item label="修改前库位" prop="storeCode">
          <el-input v-model="storeForm.storeCode" placeholder="请输入修改前库位"/>
        </el-form-item>  -->
