...
export function listTax_innoticedtl(query) {
  return request({
    url: '/taxstore/tax_innoticedtl/list',
    method: 'get',
    params: query
  })
}
...
export function getTax_innoticedtl(inNoticeDtlId) {
  return request({
    url: '/taxstore/tax_innoticedtl/' + inNoticeDtlId,
    method: 'get'
  })
}
...
export function listTax_innoticedtlbydocid(inNoticeDocId) {
  console.info("dffa");
  return request({
    url: '/taxstore/tax_innoticedtl/docId/' + inNoticeDocId,
    method: 'get'
  })
}
