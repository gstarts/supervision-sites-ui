...
export function listContainer(query) {
  return request({
    url: 'site/container/container/list',
    method: 'get',
    params: query
  })
}
...
export function getContainer(id) {
  return request({
    url: 'site/container/container/' + id,
    method: 'get'
  })
}
...
export function exportContainer(query) {
  return request({
    url: 'site/container/container/export',
    method: 'get',
    params: query
  })
}
...
export function getdelContainerInfo( id ){
  return request({
    url: 'site/container/container/info/' + id,
    method: 'get',
  })
}
...
export function getdelContainerInfoBody( id ){
  return request({
    url: 'site/container/container/infoBody/' + id,
    method: 'get',
  })
}
...
export function init(){
  return request({
    url: 'site/container/container/init',
    method: 'get',
  })
}
...
export function addBody(data) {
  return request({
    url: 'site/container/container/body',
    method: 'post',
    data: data
  })
}
...
export function getBody(id) {
  return request({
    url: 'site/container/container/body/' + id,
    method: 'get'
  })
}
