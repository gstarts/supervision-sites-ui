...
export function listDeclare(query) {
  return request({
    url: '/manifest/declare/head/list',
    method: 'get',
    params: query
  })
}
...
export function listbodyTable(query) {
  return request({
    url: '/manifest/declare/body/list',
    method: 'get',
    params: query
  })
}
...
export function autoAllocation(data){
  return request({
    url: '/manifest/declare/allocation',
    method: 'post',
    data: data
  })
}
...
export function check(vehicleNo,headId ){
  return request({
    url: '/manifest/declare/check/'+ vehicleNo+"/"+headId ,
    method: 'get'
  })
}
...
export function subReject(id,message){
  return request({
    url: '/manifest/declare/reject/'+ id+"/"+message ,
    method: 'get'
  })
}
// 人工办结
